<?php
    ...
    $nopernyataan  = "";
    $norawat       = "";
    $_sql          = "select * from antripenolakanresusitasi" ;  
    ...
    $saksi_keluarga                 = "";
    $_sql2  = "select surat_penolakan_resusitasi.tanggal,dokter.nm_dokter,surat_penolakan_resusitasi.pembuat_pernyataan,surat_penolakan_resusitasi.alamat_pembuat_pernyataan,
               ...
               where surat_penolakan_resusitasi.no_pernyataan='$nopernyataan'" ;  
    $hasil2 = bukaquery2($_sql2);
    while ($data2  = mysqli_fetch_array ($hasil2)){
...
<body>
    <div class="container">
        <h5 class="text-dark"><center><button class="btn btn-secondary" onclick="window.location.reload();">Refresh</button><br/><br/>Penolakan Resusitasi<br> No. <?=$nopernyataan;?></center></h5>
        ...
        <form method="POST" action="pages/storeImage.php" onsubmit="return validasiIsi();" enctype=multipart/form-data>
            ...
            <span class="paragraf-pernyataan text-dark">
                Saya menyatakan bahwa jika jantung keluarga saya berhenti berdetak / berhenti bernapas, tidak ada prosedur medis untuk mengembalikan pernapasan atau jantung berfungsi kembali yang akan dilakukan oleh staf Rumah Sakit.
            </span>
            <span class="paragraf-pernyataan text-dark">
