...
import rekammedis.RMRiwayatKunjungan;
import rekammedis.RMRiwayatPenunjang;
import rekammedis.RMRiwayatPerawatan;
import rekammedis.RMRiwayatSOAPIE;
...
//        BtnRujukInternalKMM.setMnemonic('4');
        ...
        BtnRujukInternalKMM.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                //ambil dari tombol Rujuk Internal
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnInputResepKMMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnInputResepKMMActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{   
    ...
    }//GEN-LAST:event_BtnInputResepKMMActionPerformed
    ...
    private void BtnRujukKeluarKMMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRujukKeluarKMMActionPerformed
        if(TNoRw.getText().trim().equals("")){
            ...
            if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                ...
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                Valid.editTable("reg_periksa","no_rawat",TNoRw,"stts='Dirujuk'");
    ...
    private void BtnRiwayatPengobatanActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu pasien...!!!");
            TCari.requestFocus();
        } else {
    ...
    private void BtnRiwayatLabActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu pasien...!!!");
            TCari.requestFocus();
        } else {
    ...
    private void BtnRiwayatSoapActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu pasien...!!!");
            TCari.requestFocus();
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMRiwayatSOAPIE resume = new RMRiwayatSOAPIE(null, true);
            resume.setNoRm(TNoRM.getText(), TPasien.getText());
            resume.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
            resume.setLocationRelativeTo(internalFrame1);
            resume.setVisible(true);
    ...
    private void BtnRiwayatKunjunganActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu pasien...!!!");
            TCari.requestFocus();
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMRiwayatKunjungan resume = new RMRiwayatKunjungan(null, true);
            resume.setNoRm(TNoRM.getText(), TPasien.getText());
            resume.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
            resume.setLocationRelativeTo(internalFrame1);
            resume.setVisible(true);
    ...
    */
    ...
    private void inputResep() {
        ...
        if (resepobat == null) return;
        if (!resepobat.isVisible()) {
            resepobat.setNoRmKmm(TNoRw.getText(),DTPTgl.getDate(),cmbJam.getSelectedItem().toString(),cmbMnt.getSelectedItem().toString(),cmbDtk.getSelectedItem().toString(),KdDok.getText(),TDokter.getText(),"ralan");
            resepobat.isCek();
            resepobat.tampilobat();
            if(!pilihiterasi.equals("")){
                resepobat.pilihIterasi(pilihiterasi);
