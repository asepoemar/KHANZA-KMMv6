...
public class DlgTemplateResep extends javax.swing.JDialog {
    ...
    public DlgTemplateResep(java.awt.Frame parent, boolean modal) {
        ...
        // renderer warna default untuk semua kolom
        tbPemisahan.setDefaultRenderer(Object.class, new WarnaTable());
        
        // Renderer gabungan: WarnaTable + Bold
        DefaultTableCellRenderer boldWarnaRenderer = new WarnaTable() {
            @Override
            public Component getTableCellRendererComponent(JTable table, Object value,
                                                           boolean isSelected, boolean hasFocus,
                                                           int row, int column) {
                Component c = super.getTableCellRendererComponent(table, value, isSelected, hasFocus, row, column);
                c.setFont(c.getFont().deriveFont(Font.BOLD)); // tambahkan efek bold
                return c;
            }
        };

        // Terapkan ke kolom "Nama Template" (indeks 8)
        tbPemisahan.getColumnModel().getColumn(8).setCellRenderer(boldWarnaRenderer);


//        // renderer khusus untuk kolom "Nama Template" (indeks 8)
...
//                                                           int row, int column) {
//                Component c = super.getTableCellRendererComponent(table, value, isSelected, hasFocus, row, column);
//                c.setFont(c.getFont().deriveFont(Font.BOLD)); // font tebal
//                return c;
//            }
//        };
//        tbPemisahan.getColumnModel().getColumn(8).setCellRenderer(boldRenderer);
...
*/
    ...
    //kmm button hapus hanya untuk di tabel resep_obat_template saja
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            if(tbPemisahan.getValueAt(tbPemisahan.getSelectedRow(),0).toString().equals("")){
                ...
                Sequel.meghapus("resep_obat_template","no_resep",tbPemisahan.getValueAt(tbPemisahan.getSelectedRow(),0).toString()); 
                tampil();               
            }
        }
    ...
    private void TCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TCariKeyPressed
        //KMM - Jika pengguna menekan Enter, maka otomatis menjalankan fungsi pencarian
